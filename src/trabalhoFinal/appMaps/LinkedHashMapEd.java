...
public class LinkedHashMapEd {
	...
	public LinkedHashMap<String, Integer> inserir() {
		LinkedHashMap<String, Integer> nomes = new LinkedHashMap<String, Integer>();
		try {
		...
		try {
			FileWriter arq = new FileWriter("NomesLinkedHashMap.txt");
	...
	public double pesquisar(LinkedHashMap<String, Integer> nomes) {
		double inicio;
		double fim;
	...
	public double remover(LinkedHashMap<String, Integer> nomes) {
		double inicio;
		double fim;
