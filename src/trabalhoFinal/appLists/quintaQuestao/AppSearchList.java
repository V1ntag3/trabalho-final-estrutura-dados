package trabalhoFinal.appLists.quintaQuestao;
...
public class AppSearchList {
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("4 - Tempo para procurar 10 palavras na LinkedList");
			System.out.println("5 - Tempo para procurar 10 palavras na ArrayList");
			System.out.println("6 - Tempo para procurar 10 palavras no Vector");
			...
			if (op == 1) {
				...
				try {
					FileReader arq = new FileReader("No-repeat-leipzig100k.txt");
				...
				for (int i = 0; i < nome.size(); i++) {
					if (testeList.contains(nome.get(i)) == true) {
						System.out.println(nome.get(i) + "encontrado\n");
					}
				}
				tempo = timer.elapsedTime();
				System.out.println("Tempo total de procura das 10 palavras = " + tempo);
			} else if (op == 5) {
				StopwatchCPU timer = new StopwatchCPU();
				for (int i = 0; i < nome.size(); i++) {
